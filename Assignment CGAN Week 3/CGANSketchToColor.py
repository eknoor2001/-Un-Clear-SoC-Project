# -*- coding: utf-8 -*-
"""CGANSketchToColourImage.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-tszPy9BfzcSzEv7vn8XozHSmyKf90M8

## **CGAN Sketch To Colour Image Implementation**

*Using CGAN for Changing Sketches to Predictive Colour Images *
"""
...
! unzip /content/anime-sketch-colorization-pair.zip -d train
...
#function to return input-image(b/w sketch) and real image, from the dataset
...
#random-jitter transforms the image to various flipped, rotated, etc. forms
...
#Function to get final pre-porcessed inputs and shuffle them \
